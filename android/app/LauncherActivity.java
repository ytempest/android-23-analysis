...
public abstract class LauncherActivity extends ListActivity {
    ...
    /**
     * Description：这个类封装了手机界面上一个App的图标、名称、包名等
     */
    ...
    private class ActivityAdapter extends BaseAdapter implements Filterable {
        ...
        /**
         * 解析 position位置的 app图标的intent
         *
         * @param position 用户点击的手机主界面上的app图标位置
         */
    ...
    protected void onCreate(Bundle icicle) {
        ...
        // 2、设置 LauncherActivity的布局
        onSetContentView();

        // 3、创建一个 IconResizer对象，用于解析app的图标
        mIconResizer = new IconResizer();

        // 4、获取一个基本的Intent
        mIntent = new Intent(getTargetIntent());
        mIntent.setComponent(null);
        // 5、创建ListView的适配器，并设置到ListView当中
    ...
    /**
     * 当用户点击手机界面上的app图标就会走到这个方法中，然后启动指定app
     *
     * @param v        点击的View
     * @param position 点击View的位置
     */
    @Override
    protected void onListItemClick(ListView l, View v, int position, long id) {
        // 获取指定位置app图标的intent，这个Intent是通过指定app的包名来启动指定app的
        Intent intent = intentForPosition(position);
        // 启动指定的app的主界面Activity
