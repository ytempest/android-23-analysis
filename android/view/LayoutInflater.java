...
public abstract class LayoutInflater {
     ...
     *
     * @param name   View的全路径名
     * @param prefix View的前缀，如果是系统的View，那么就会有 "android.view." 这个前缀，否则就没有
     * @param attrs  The XML attributes supplied for this instance.
     * @return View The newly instantiated view, or null.
     */
    public final View createView(String name, String prefix, AttributeSet attrs)
            throws ClassNotFoundException, InflateException {
        // 由此我们知道，View的创建是通过反射的
        ...
        try {
            ...
            if (constructor == null) {
                ...
                // 如果缓存中没有缓存这个View的构造器，那么就View的名字加载这个View的Class文件
    ...
    View createViewFromTag(View parent, String name, Context context, AttributeSet attrs,
        ...
        try {
            ...
            if (mFactory2 != null) {
                ...
                // 如果为 LayoutInflater设置了View工厂，那么就调用工厂的 onCreateView()方法
            ...
            if (view == null) {
                ...
                try {
                    if (-1 == name.indexOf('.')) {
                        // 如果是系统的View，那么就调用该方法创建View
                        view = onCreateView(parent, name, attrs);
                    } else {
                        // 如果是自定义View，那么就调用该方法创建View
