...
public final class ViewTreeObserver {
     ...
     * 通知所有监听器，View的绘制即将开始。如果该方法返回true，表示取消绘制View，并重新scheduled View
     * 的绘制。如果你想对那些还没有添加到Window或者为GONE状态的View强制其在View视图和View的层次结构
     * 上进行绘制，那么可以手动调用该命令
     *
     * @return True if the current draw should be canceled and resceduled, false otherwise.
     * 返回true表示当前的绘制会被取消，并重新scheduled/
     */
