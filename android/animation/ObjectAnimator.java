...
public final class ObjectAnimator extends ValueAnimator {
    ...
    public void setPropertyName(@NonNull String propertyName) {
        ...
        if (mValues != null) {
            // 首先会从 mValues数组中获取，可能是为了复用
            PropertyValuesHolder valuesHolder = mValues[0];
            // 1、获取旧的那个PropertyValuesHolder对象的动画属性名称
            String oldName = valuesHolder.getPropertyName();
            // 2、更新PropertyValuesHolder对象的动画属性名称
            valuesHolder.setPropertyName(propertyName);
            // 3、删除旧的PropertyValuesHolder对象，防止出问题
    ...
    public void setFloatValues(float... values) {
        ...
        if (mValues == null || mValues.length == 0) {
            ...
            if (mProperty != null) {
                ...
                // 一般来说，我们都是使用属性名称来进行动画的，所以就会走到这里
                // 初始化 mValues 和 mValuesMap
    ...
    @Override
    public void start() {
        // 获取当前线程的 AnimationHandler对象，然后通过这个对象获取到一些动画，并对
        // 这些动画的进行一些检测
