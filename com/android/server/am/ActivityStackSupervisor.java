...
public final class ActivityStackSupervisor implements DisplayListener {
    ...
    void startHomeActivity(Intent intent, ActivityInfo aInfo, String reason) {
        ...
        // inResumeTopActivity默认为false，一般不会走这里
    ...
    void startSpecificActivityLocked(ActivityRecord r,
        ...
        if (app != null && app.thread != null) {
            try {
                ...
                // 启动的Activity所需要的应用进程已经启动，则通过该方法调用到IApplicationThread#scheduleLaunchActivity方法
        ...
        // 启动的Activity所需要的应用进程若未启动则会走到这里启动应用进程
    ...
    final int startActivityLocked(IApplicationThread caller,
        ...
        // 在startActivityLocked()方法中会获取Activity的信息并封装成ActivityRecord，比如Intent
        // 并根据Activity的启动模式执行了相关逻辑
    ...
    final int startActivityUncheckedLocked(final ActivityRecord r, ActivityRecord sourceRecord,
        ...
        targetStack.mLastPausedActivity = null;
        // 在startActivityUncheckedLocked()中会根据启动相关信息获取正确的ActivityStack栈，然后启动Activity
