...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    public PhoneWindow(Context context) {
        super(context);
        // 初始化 LayoutInflater，后面会使用这个LayoutInflater加载View
    ...
    public void setContentView(int layoutResID) {
        ...
        // before this happens.
        // mContentParent其实是DecorView布局中的根ViewGroup，这个ViewGroup用来摆放Activity的Layout布局
        if (mContentParent == null) {
    ...
    private final class DecorView extends FrameLayout implements RootViewSurfaceTaker {
        ...
        /**
         * DecorView的 onMeasure()方法主要是根据手机屏幕的宽高、是否横屏去重新规定一个
         * 新的宽度和高度的测量规格
         *
         * @param widthMeasureSpec  Window的宽度测量规格
         * @param heightMeasureSpec Window的高度测量规格
         */
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            // 2、面会根据宽高的模式进行不同的测量，以及选择相应的宽度单位
            ...
            // 3、DecorView完成了自己的测量逻辑后就直接教给父类FrameLayout遍历子View进行测量
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        // 获取 DecorView中存放 Activity的布局ViewGroup
    ...
    private void installDecor() {
        ...
        // 获取存放Activity的Layout布局的一个ViewGroup
        if (mContentParent == null) {
            // generateLayout()方法会通过 findViewById(ID_ANDROID_CONTENT)获取到DecorView布局中的
            // 一个ViewGroup，可以存放 Activity的Layout布局文件
